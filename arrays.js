...
indexOfNewcastle = stations.indexOf("Newcastle");
stations.splice(indexOfNewcastle+1,0,"Darlington");
 console.log(stations);
...
console.log(stoppingAtDurham, "index of returned -1 which means Durham isn't in the list");
